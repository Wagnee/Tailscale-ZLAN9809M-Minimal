...
O processo clona exatamente a tag/commit fixados, produz daemon e CLI separados, comprime, testa os arquivos UPX, atualiza SHA-256 e gera o payload persistente. O workflow repete o build completo em cada push.
